...
let MaincreenSlider = new Swiper('.main-screen__slider', {
	effect: 'fade',
	keyboard: {
		enabled: true,
		onlyInViewport: true,
...
let CompletedWorksSlider = new Swiper('.bottom-completed__slider', {
	slidesPerView: 6,
	spaceBetween: 32,
	slidesPerGroup: 2,
	speed: 500,
...
function mapInit(n = 1) {
	...
	var locations = [
		[new google.maps.LatLng(55.71370506587345, 37.573025607322876)],
	]
	var options = {
		zoom: 17,
		panControl: false,
